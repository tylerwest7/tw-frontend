    ...
    <PageWrapper>
      <div className="ml-9 mr-9 lg:ml-24 lg:mr-24  tracking-[-0.025rem] lg:tracking-[-0.05rem] pt-[10vh] pb-[10vh]">
        <div className="grid grid-cols-2 items-center">
          ...
          <div className="p-9">
            <h1 className="text-4xl lg:text-[4rem] pb-9">About</h1>
            <h1>
              Introducing Tyler, a proficient 3D designer with roots in
              Michigan. Starting as a motion design intern at Hornet, he swiftly
              honed his craft. His expertise lies in the realm of 3D
              simulations, with Houdini as his go to tool. During his off hours,
              he enjoys the tranquility of Lake Michigan and experiencing live
              music. Currently, he works at Carnevale, seamlessly blending the
              worlds of 3D design and UI design, showcasing his commitment to
              pushing creative boundaries. <br /> - Chat GPT
            </h1>
          </div>
        </div>
      </div>
